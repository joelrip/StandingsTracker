...
api_usl_one <- GET(
  "https://v3.football.api-sports.io/fixtures?season=2026&league=489",
  add_headers(
...
USLOnePointsLong = StandingsTracker(USLOneScores, NA, 32, 8, 9)
...
api_usl <- GET(
  "https://v3.football.api-sports.io/fixtures?season=2026&league=255",
  add_headers(
    'x-rapidapi-host' = "v3.football.api-sports.io",
    'x-rapidapi-key' = Sys.getenv("API_SPORTS_API_KEY")
  )
...
api_mls <- GET(
  "https://v3.football.api-sports.io/fixtures?season=2026&league=253",
  add_headers(
    'x-rapidapi-host' = "v3.football.api-sports.io",
    'x-rapidapi-key' = Sys.getenv("API_SPORTS_API_KEY")
  )
