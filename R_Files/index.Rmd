...
date: "Updated September 24, 2017"
output: 
...
<p class="intro">Graphing the progress of the 2017 season, game by game.</p>
...
cols = c("#e6194b", "#3cb44b", "#ffe119", "#0082c8", "#f58231", "#911eb4", "#46f0f0", "#f032e6", "#d2f53c",
          "#800000", "#008080", "#e6beff", "#aa6e28", "#eee9b7", "#fabebe") 
```
...
highchart() %>%
  ...
  hc_colors(cols) %>%
  hc_yAxis(title = list(text = "Points Minus Games Played"), max = 35, min = -15, endOnTick = F) %>%
  hc_xAxis(title = list(text = "Game")) %>%
  hc_add_annotation(title = list(text = "Clinched<br/>Playoffs"), xValue = 34, yValue = 30) %>%
  hc_add_annotation(title = list(text = "Mathematically<br/>Eliminated"), xValue = 34, yValue = -10) %>%
...
highchart() %>%
  ...
  hc_yAxis(title = list(text = "Points Minus Games Played"), max = 35, min = -15, endOnTick = F) %>%
  hc_xAxis(title = list(text = "Game")) %>%
  hc_add_annotation(title = list(text = "Clinched<br/>Playoffs"), xValue = 32, yValue = 30) %>%
  hc_add_annotation(title = list(text = "Mathematically<br/>Eliminated"), xValue = 32, yValue = -10) %>%
  hc_legend(align = "right", verticalAlign = "middle", layout = "vertical") %>%
  hc_tooltip(crosshairs = T, backgroundColor = "#fcffc5", shared = T,
             formatter = JS("function() {
                            var s = '<strong>Game '+ this.x +'</strong>';
